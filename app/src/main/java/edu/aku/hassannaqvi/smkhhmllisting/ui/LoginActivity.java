...
import static edu.aku.hassannaqvi.smkhhmllisting.core.MainApp.editor;
import static edu.aku.hassannaqvi.smkhhmllisting.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.smkhhmllisting.database.CreateTable.DATABASE_COPY;
import static edu.aku.hassannaqvi.smkhhmllisting.database.CreateTable.DATABASE_NAME;
...
*/
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.smkhhmllisting.ui.SyncActivity.class).putExtra("login", true));
        } else {
